...
def bar_small_multiples_per_algo(
    csv_path: str,
    title: str = "Steps by Algorithm (per-test bars, row order)",
    ...
    'World complexity rank' is implicit: row_index * 1000 (+ optional base).
    ...
    # world complexity rank = row_index * 1000 (1-based) + 14000 offset (as in your example)
    ...
    # NOTE: do NOT use constrained_layout; we’ll manage margins ourselves
    ...
    for k, algo in enumerate(algos):
        ...
        # custom x ticks → full numbers (15000, 16000, …) rotated
    ...
    # title and layout: leave room at top
    if title:
        fig.suptitle(title, y=0.98)

    # reserve margins so titles/labels don’t get cut off
